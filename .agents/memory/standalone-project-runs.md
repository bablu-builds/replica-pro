...
The RMAO Python backend is intentionally exercised through its `rmao` CLI and
HTTP server entry points; the workspace's existing Node preview workflows do
not serve it automatically.
